...
const Testimonial = ({className, image, alt, name, info, text}) => {
  return (
    <div className={`${className} p-6 flex flex-col sm:flex-row items-stretch  bg-primary-50/95 backdrop-blur-2xl border border-neutral-200 rounded shadow-lg 2xl:shadow-black/40 `}>
      <div className=' sm:mr-8 mb-4 sm:mb-0 w-full sm:w-[160px]  text-center flex sm:flex-col items-center sm:justify-center gap-6 sm:gap-4 '>
        ...
        <div className='flex flex-col items-start sm:items-center '>
          ...
          <div className=' text-primary text-start sm:text-center'>{info}</div>
